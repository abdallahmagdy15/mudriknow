...
const en = {
  ...
  showSplashOnStartup: "Show splash on startup",
  showSplashOnStartupHint: "Show a brief Mudrik splash screen every time the app starts.",
...
const ar: Record<Key, string> = {
  ...
  showSplashOnStartup: "إظهار شاشة البداية",
  showSplashOnStartupHint: "عرض شاشة بداية مختصرة لمدرك في كل مرة يبدأ فيها التطبيق.",
