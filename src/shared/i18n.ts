...
const ar: Record<Key, string> = {
  ...
  allowReadOnlyCommands: "السماح بأوامر القراءة فقط",
  allowReadOnlyCommandsHint: "يتيح للذكاء الاصطناعي تشغيل مجموعة محددة من أوامر القراءة فقط (فحص git، حالة النظام، تحليل السجلات). مُصفّى بدقة — لا كتابة أو تعديل أو حذف. معطل افتراضيًا.",
